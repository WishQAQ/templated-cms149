...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class=\"page_y\" href='".str_replace("{page}",$prepagenum,$tnamerule)."'><img src=\"/templets/yx/images/page_y1.jpg\"></a>\r\n";
            $indexpage="<a href='".str_replace("{page}",1,$tnamerule)."'>首页</a>\r\n";
        }
        else
        {
		    $prepage.="<a class=\"page_y\"><img src=\"/templets/yx/images/page_y1.jpg\"></a>\r\n";
            $indexpage="首页\r\n";
        }
        ...
        {
            $nextpage.="<a class=\"page_y\" href='".str_replace("{page}",$nextpagenum,$tnamerule)."'><img src=\"/templets/yx/images/page_y2.jpg\"></a>\r\n";
            $endpage="<a href='".str_replace("{page}",$totalpage,$tnamerule)."'>末页</a>\r\n";
        }
        else
        {
		    $nextpage.="<a class=\"page_y\"><img src=\"/templets/yx/images/page_y2.jpg\"></a>\r\n";
            $endpage="末页\r\n";
        }
